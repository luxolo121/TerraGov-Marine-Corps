/obj/machinery/vending/weapon
	...
	products = list(
		"Rifles" = list(
			...
			/obj/item/ammo_magazine/rifle/tx11/statikk = -1,
...
/obj/machinery/vending/uniform_supply
	...
	products = list(
		...
		"Pouches" = list(
			...
			/obj/item/storage/holster/flarepouch = -1,
...
/obj/machinery/vending/valhalla_seasonal_req
	...
	products = list(
		...
		"Syndicate" = list(
			...
			/obj/item/weapon/gun/minigun/vsd_autocannon = -1,
			/obj/item/ammo_magazine/rifle/vsd_autocannon = -1,
			/obj/item/weapon/gun/flamer/vsd = -1,
			/obj/item/ammo_magazine/flamer_tank/vsd = -1,
			/obj/item/weapon/gun/at45 = -1,
			/obj/item/ammo_magazine/at45 = -1,
