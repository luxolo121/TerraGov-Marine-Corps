...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	/obj/structure/barricade/solid = new /datum/stack_recipe("metal barricade", /obj/structure/barricade/solid, BUILD_COST_METAL_CADE, time = 1.5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_METAL), \
	...
	/obj/item/stack/razorwire = new /datum/stack_recipe("razor wire", /obj/item/stack/razorwire, 4, 2, 20, time = 1 SECONDS, crafting_flags = NONE, skill_req = SKILL_CONSTRUCTION_METAL), \
	/obj/structure/barricade/folding/metal = new /datum/stack_recipe("folding metal barricade", /obj/structure/barricade/folding/metal, BUILD_COST_METAL_CADE_FOLDABLE, time = 1.5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_METAL), \
	null, \
...
GLOBAL_LIST_INIT(plasteel_recipes, list( \
	/obj/structure/barricade/folding = new /datum/stack_recipe("folding plasteel barricade", /obj/structure/barricade/folding, BUILD_COST_PLASTEEL_CADE_FOLDABLE, time = 1.5 SECONDS, crafting_flags = CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_PLASTEEL), \
	/obj/structure/barricade/solid/plasteel = new /datum/stack_recipe("plasteel barricade", /obj/structure/barricade/solid/plasteel, BUILD_COST_PLASTEEL_CADE, time = 1.5 SECONDS, crafting_flags = CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_PLASTEEL), \
))
