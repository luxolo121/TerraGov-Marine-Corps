...
#define SILO_BASE_OUTPUT_PER_MARINE 0.5
...
#define NUCLEAR_WAR_MECH_MINIMUM_POP_REQUIRED 0 // This amount of clients must be connected at gamemode setup to get the first mech pilot slot.
#define NUCLEAR_WAR_MECH_INTERVAL_PER_SLOT 1 // After meeting NUCLEAR_WAR_MECH_MINIMUM_POP_REQUIRED, a mech pilot slot is open for each set of X clients.
#define NUCLEAR_WAR_TANK_MINIMUM_POP_REQUIRED 0 // This amount of clients must be connected at gamemode setup to get two assault crewman jobs (and thus tank).
