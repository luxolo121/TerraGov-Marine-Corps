...
/datum/ammo/energy/bfg
	...
	shell_speed = 0.2
	damage = 150 * MARINE_DAMAGE_SCALING_HEAVY
	penetration = 50
	max_range = 20
...
/datum/ammo/energy/lasgun/M43/heat
	...
	damage = 12 * MARINE_DAMAGE_SCALING_LIGHT //""""requires mod with -0.15 multiplier should math out to 10""" cry
...
/datum/ammo/energy/lasgun/M43/blast
	...
	accurate_range = 5
	max_range = 5
	damage = 42 * MARINE_DAMAGE_SCALING_LIGHT
	damage_falloff = 10
	penetration = 0
	sundering = 5
...
/datum/ammo/energy/lasgun/pulsebolt
	...
	icon_state = "pulse2"
	hud_state = "pulse"
	damage = 45 * MARINE_DAMAGE_SCALING_LIGHT // """this is gotta hurt..."""" bro its 45dmg
	max_range = 40
	penetration = 100
	sundering = 100
...
/datum/ammo/energy/lasgun/M43/practice
	...
	icon_state = "disablershot"
	hud_state = "laser_disabler"
	damage = 45 * MARINE_DAMAGE_SCALING_LIGHT // why would you use this
	penetration = 0
	damage_type = STAMINA
	ammo_behavior_flags = AMMO_ENERGY
	bullet_color = COLOR_DISABLER_BLUE
